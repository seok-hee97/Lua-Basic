-- Two consecutive dashes start a one-line comment.

--[[
    Adding two more brackets, like this, starts a multi-line comment.
    Closing it with two matching brackets ends the comment.
--]]
...
-- machine precision is not a problem for ints that need less than 52 bits.
...
-- Returns, function calls, and assignments all work with
-- lists that may be mismatched in length.
...
-- Now x = 4, y = 8; values 15, 16, 23, and 42 are discarded.
...
-- Function calls with one string param don't need parens:
...
--[[
I had a lot of fun learning Lua so I could make games
...
-- Reference: https://tylerneylon.com/a/learn-lua/
