...
When in doubt, always use explicit parentheses. It is easier than looking up in the manual,
and probably you will have the same doubt when you read the code again.
