...
-- Like control structures, all logical operators consider false and nil as false
...
--  (or simply `a and b or c`, because `and` has a higher precedence than `or`),
...
-- and then the `or` expression results in the value of its first expression, x.
